          ...
          <div className="lg:col-span-4">
            <Reveal delay={0.15}>
              <figure className="relative overflow-hidden rounded-3xl border border-ink/10 bg-white isolate">
                <div className="absolute -inset-0 translate-x-2 translate-y-2 rounded-3xl border border-gold/20 pointer-events-none z-0" />
                <img
                  src="/images/context-candles.jpg"
                  alt="Velas acesas em uma nave de catedral, em preto e branco"
                  className="relative z-10 w-full h-auto object-cover grayscale contrast-125 aspect-[4/3]"
                />
